...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Ping-Pong-PyGame.py"
 
        #Name of program
        self.project_name = "Ping Pong Pygame"
 
        #Project url
        self.project_url = "http://marbellajordan.github.io/Ping-Pong-PyGame/"
        ...
        #Auhor of program
        self.author_name = "Jordan Y. Marbella"
        self.author_email = "hiseki21129@gmail.com"
        self.copyright = "Copyright (c) 2015"
 
        #Description
        self.project_description = "This is just a simple pygame i created using Python enjoy!"
